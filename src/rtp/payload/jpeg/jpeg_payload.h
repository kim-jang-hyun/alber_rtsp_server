#ifndef __RTSP_SERVER_RTP_PAYLOAD_JPEG_JPEG_PAYLOAD_H__
#define __RTSP_SERVER_RTP_PAYLOAD_JPEG_JPEG_PAYLOAD_H__
...
public:
    ...
    void makePayload(FrameParserPtr frame_parser,
...
#endif // __RTSP_SERVER_RTP_PAYLOAD_JPEG_JPEG_PAYLOAD_H__
