#ifndef __RTSP_SERVER_RTP_PAYLOAD_JPEG_JPEG_FRAME_PARSER_H__
#define __RTSP_SERVER_RTP_PAYLOAD_JPEG_JPEG_FRAME_PARSER_H__
...
class JpegFrameParser : public FrameParser
{ 
public: 
    JpegFrameParser();
    ...
    unsigned char* getScanData() const { return m_scan_data; }
    std::size_t getScanDataSize() const { return m_scan_data_size; }
...
#endif // __RTSP_SERVER_RTP_PAYLOAD_JPEG_JPEG_FRAME_PARSER_H__
